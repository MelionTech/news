...
<footer id="colophon" class="site-footer border-top">
	<?php if (get_theme_mod('magazine_express_show_hide_footer', true)) {?>
			            ...
			            <div class="footer-menu-left">
			            	<?php if(! get_theme_mod('magazine_express_footer_text_setting') ){ ?>
							    <a href="<?php echo esc_url( 'https://wordpress.org/' ); ?>">
									...
									printf( esc_html__( 'Proudly powered by %s', 'viral-news-center' ), 'WordPress' );
									?>
							    </a>
							    <span class="sep mr-1"> | </span>
							    <span>
							        <a target="_blank" href="<?php echo esc_url( 'https://www.themagnifico.net/products/free-news-wordpress-theme'); ?>">
							           	<?php
							            	/* translators: 1: Viral News WordPress Theme,  */
							            	printf( esc_html__( ' %1$s', 'viral-news-center' ),'Viral News WordPress Theme' );
							            ?>
							    	</a>
							        <?php
							        	/* translators: 1: TheMagnifico. */
							        	printf( esc_html__( 'by %1$s.', 'viral-news-center' ),'TheMagnifico'  );
							        ?>
							    </span>
							<?php }?>
	...
	<?php } ?>
      ...
      <a id="button"><?php esc_html_e('TOP','viral-news-center'); ?></a>
    <?php } ?>
</footer>
</div>
